"""
MVC Calculator v2.0 – Clean architecture + Full Comparison Feature
"""
...
class DataRepository:
    ...
    def get_resort_data(self, resort_name: str) -> Optional[Dict]:
        return self._resorts_by_name.get(resort_name)          # <-- FIXED LINE
...
# ====================================================================
# CALCULATION ENGINE (with full comparison)
# ====================================================================
...
def main():
    ...
    # ---------- Sidebar (keep exactly your existing code) ----------
    with st.sidebar:
        st.header("Configuration")
        user_mode = st.selectbox("User Mode", ["Renter", "Owner"], key="mode")

        if user_mode == "Owner":
            # ... your existing Owner inputs ...
